...
const blogAction = (() => {
    ...
    const makeBlog = () => {
        ...
        const postOne = blogPost('#1', '1 month with The Odin Project', _Posts__WEBPACK_IMPORTED_MODULE_0__["default"].post_one);
...
const homeAction = (() => {
  const makeHome = () => {
    ...
    home_text.innerHTML = "◊ Welcome to my blog!";
...
const photoAction = (() => {
  const makePhotos = () => {
    ...
    photoArray[0] = "https://cdn.pixabay.com/photo/2022/08/22/13/08/leaf-7403639_1280.jpg";
    photoArray[1] = "https://cdn.pixabay.com/photo/2022/08/13/09/05/lion-7383228_1280.jpg";
    photoArray[2] = "https://cdn.pixabay.com/photo/2018/12/15/18/02/forest-3877365__480.jpg";

    const button_left = document.createElement("button");
    button_left.textContent = "prev";
    button_left.style.width = "5vw";
    button_left.style.color = "black";

    const button_right = document.createElement("button");
    button_right.textContent = "next";
    button_right.style.width = "5vw";
    button_right.style.color = "black";

    const photo_container = document.createElement("div");
    photo_container.style.width = "30vw";
    photo_container.style.height = "40vh";
    ...
    button_right.onclick = function () { if ( i < photoArray.length - 1){ i++ }
        return photo.src = photoArray[i] }

    button_left.onclick = function () { if ( i > 0 ) { i-- }
        return photo.src = photoArray[i] }
